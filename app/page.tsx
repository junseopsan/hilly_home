            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-600 text-sm">
                  대회 신청할 때마다 사이트가 느려지고, 신청 오류가 발생해요
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <div className="w-12 h-12 bg-red-100 rounded-lg flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-gray-600 text-sm">
                  대회마다 사이트가 달라서 헷갈리고 매번 새로 가입해야 해요
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <div className="w-12 h-12 bg-red-100 rounded-lg flex items-center justify-center mx-auto mb-4">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Hilly Heally는 어떤 플랫폼인가요?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Hilly Heally는 아웃도어 대회의 신청, 결제, 참가 인증은 물론
              <br />
              GPS 하드웨어 기반 실시간 트레킹과 3D 지도 기반 트레일 콘텐츠까지
              <br />한 번에 경험할 수 있는 스마트 스포츠 플랫폼입니다.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-brand-100 hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600">
                  다양한 아웃도어 대회를 한 곳에서 탐색하고 상세 정보를 확인할
                  수 있습니다.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-brand-100 hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600">
                  결제 완료 즉시 QR 참가증이 자동 발급되어 대회장에서 간편하게
                  입장할 수 있습니다.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-brand-100 hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600">
                  내 대회 신청 내역과 참가 기록을 한눈에 확인하고 관리할 수
                  있습니다.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-brand-100 hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600">
                  대회 등록부터 참가자 관리까지 주최자를 위한 통합 관리 기능을
                  제공합니다.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600">
                  GPS 하드웨어와 연동하여 실시간 위치 추적 및 안전한 트레킹
                  경험을 제공합니다.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600">
                  한국 주요 트레일의 3D 지도, 고도 정보, 인증 지점 등 차별화된
                  지도 콘텐츠를 제공합니다.
                </p>
              </CardContent>
            </Card>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              기존 플랫폼과는 다른 Hilly Heally만의 특별함
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-brand-600 to-accent-600">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">
            지금 함께 빠른 대회 참가, 실시간 트레킹, 3D 지도 콘텐츠를
            경험해보세요!
          </h2>
          {/* <div className="flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <Card className="border-brand-100">
              ...
              <CardContent>
                <p className="text-gray-600">
                  앱에서 원하는 대회를 선택하고 신청 폼을 작성한 후, 토스 결제로
                  간편하게 결제하면 즉시 QR 참가증이 발급됩니다.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-brand-100">
              ...
              <CardContent>
                <p className="text-gray-600">
                  토스페이먼츠와 연동하여 안전하고 신뢰할 수 있는 결제 시스템을
                  제공합니다. 모든 결제 정보는 암호화되어 보호됩니다.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-brand-100">
              ...
              <CardContent>
                <p className="text-gray-600">
                  결제 완료 후 앱의 마이페이지에서 QR 참가증을 확인할 수
                  있습니다. 대회 당일 QR 코드를 스캔하여 입장하시면 됩니다.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">주식회사 힐리힐리</p>
              <p className="text-gray-400">
                서울시 서초구 서초중앙로 123, 지하 1층 1003호
              </p>
              <p className="text-gray-400">사업자번호: 720-86-03798</p>
              <p className="text-gray-400">
                TEL: 070-4006-4544 FAX: 02-6455-6023
              </p>
